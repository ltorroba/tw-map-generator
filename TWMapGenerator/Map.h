...
public:
    ...
    static void draw_sidebar_top_oda(cairo_t *cr, std::string server, int world, std::vector<Player*> players);
    static void draw_sidebar_top_odd(cairo_t *cr, std::string server, int world, std::vector<Player*> players);
